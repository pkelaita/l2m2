...
- `kimi-k2` (via Groq)
- `kimi-k2-turbo` (via Moonshot)
- `kimi-k2-thinking` (via Moonshot)
- `kimi-k2-thinking-turbo` (via Moonshot)
- `qwen-3-480b` (via Cerebras)
- `qwen-3-235b` (via Cerebras)
- `qwen-3-235b-thinking` (via Cerebras)
